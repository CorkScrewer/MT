...
public class PlayButton extends TitleScreenComponent {

	public PlayButton(float y, TitleScreen title) {
		super("Play", Color.RED, new Color(1f, 0.25f, 0.25f, 1f), TitleScreenComponentType.Button, y, TitleScreenComponentAlignment.Center, title);
	}
